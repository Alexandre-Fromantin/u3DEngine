...
#ifdef VIEW_DEBUG
    std::cout << "VIEW_DEBUG: new fov angle(" << new_fov_angle << " rad)" << std::endl;
#endif
...
#ifdef VIEW_DEBUG
    std::cout << "VIEW_DEBUG: translation on view(" << glm::to_string(translate_value) << ")" << std::endl;
#endif
...
#ifdef VIEW_DEBUG
    std::cout << "VIEW_DEBUG: rotation on view(" << glm::to_string(rotate_value) << ")" << std::endl;
#endif
...
#ifdef VIEW_DEBUG
            std::cout << "VIEW_DEBUG: Recalculate projection_matrix" << std::endl;
#endif
...
#ifdef VIEW_DEBUG
            std::cout << "VIEW_DEBUG: Recalculate view_matrix" << std::endl;
#endif
...
#ifdef VIEW_DEBUG
        std::cout << "VIEW_DEBUG: Recalculate view_projection_matrix" << std::endl;
